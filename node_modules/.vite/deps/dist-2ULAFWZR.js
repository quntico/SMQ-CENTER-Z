...
import {
  Hls
} from "./chunk-V2LX7PHO.js";
import {
  CustomVideoElement,
  MediaTracksMixin
} from "./chunk-GXC7S33A.js";
import {
  require_react
...
var ta = function(r12, e2, t3, i2) {
  if (e2 && typeof e2 == "object" || typeof e2 == "function")
    for (var a3 = $r(e2), n3 = 0, o4 = a3.length, s3; n3 < o4; n3++)
      s3 = a3[n3], !ea.call(r12, s3) && s3 !== t3 && ft(r12, s3, { get: (function(u4) {
        return e2[u4];
...
var yi = function(r12) {
  ...
  function t3(i2, a3, n3) {
    ...
    var s3 = { debug: false, minimumRebufferDuration: 250, sustainedRebufferThreshold: 1e3, playbackHeartbeatTime: 25, beaconDomain: "litix.io", sampleRate: 1, disableCookies: false, respectDoNotTrack: false, disableRebufferTracking: false, disablePlayheadRebufferTracking: false, errorTranslator: function(y4) {
      ...
      for (var y4 = arguments.length, c4 = new Array(y4), v4 = 0; v4 < y4; v4++)
        c4[v4] = arguments[v4];
      return c4;
...
var xi = function(r12) {
  ...
  if (r12) {
    ...
    return n3.forEach(function(o4, s3) {
      for (var u4 = o4.replace(/['"]+/g, "").split("="), p6 = 0; p6 < u4.length; p6++)
        u4[p6] === "DATA-ID" && (e2["DATA-ID"] = u4[1 - p6]), u4[p6] === "VALUE" && (e2.VALUE = u4[1 - p6]);
    }), { data: e2 };
  }
};
var Wr = Fe;
...
function De2(e2, t3) {
  ...
  t3.on(g2.Events.MANIFEST_PARSED, function(l3, u4) {
    ...
    for (let T3 of e2.videoRenditions)
      T3.id && !d5.includes(T3.id) && c4.removeRendition(T3);
  });
  let n3 = (l3) => {
  ...
  let o4 = () => {
    for (let l3 of e2.videoTracks)
      e2.removeVideoTrack(l3);
  }, s3 = () => {
    for (let l3 of e2.audioTracks)
      e2.removeAudioTrack(l3);
  }, a3 = () => {
    o4(), s3();
  };
...
async function ve2(e2, t3, r12, n3) {
  ...
  return o4 || (o4 = ne2(e2, n3, r12), o4.mode = "hidden", await new Promise((s3) => setTimeout(() => s3(void 0), 0))), o4.mode !== "hidden" && (o4.mode = "hidden"), [...t3].sort((s3, a3) => re2(a3) - re2(s3)).forEach((s3) => {
    ...
    if ("endTime" in s3 && s3.endTime != null)
      o4 == null || o4.addCue(new VTTCue(i2, s3.endTime, n3 === "chapters" ? a3 : JSON.stringify(a3 != null ? a3 : null)));
    else {
...
function ke2(e2, t3 = { label: oe }) {
  var s3, a3;
  let r12 = w(e2, t3.label, "metadata");
  if (!((s3 = r12 == null ? void 0 : r12.activeCues) != null && s3.length))
    return;
...
var de2 = async (e2, t3) => {
  ...
  try {
    ...
    if (!((r12 = s3 == null ? void 0 : s3[0]) != null && r12.metadata))
      return;
    for (let l3 of s3[0].metadata)
      l3.key && l3.value && (a3[l3.key] = l3.value);
...
var Gt2 = (e2, t3, r12) => {
  ...
  if (v(t3, "durationchange", u4), t3 && n3) {
    ...
    r12 && o4 ? (r12.once(g2.Events.LEVEL_LOADED, (p6, T3) => {
...
var qt2 = (e2, t3) => {
  ...
  let n3 = { [g2.ErrorTypes.NETWORK_ERROR]: f.MEDIA_ERR_NETWORK, [g2.ErrorTypes.MEDIA_ERROR]: f.MEDIA_ERR_DECODE, [g2.ErrorTypes.KEY_SYSTEM_ERROR]: f.MEDIA_ERR_ENCRYPTED }, o4 = (d5) => [g2.ErrorDetails.KEY_SYSTEM_LICENSE_REQUEST_FAILED, g2.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_REQUEST_FAILED].includes(d5.details) ? f.MEDIA_ERR_NETWORK : n3[d5.type], s3 = (d5) => {
    if (d5.type === g2.ErrorTypes.KEY_SYSTEM_ERROR)
      return C2.DRM;
    if (d5.type === g2.ErrorTypes.NETWORK_ERROR)
      return C2.VIDEO;
  }, a3, i2 = o4(e2);
...
var ue2 = (e2, t3) => {
  ...
  if (typeof e2 != "object" || e2 === null || typeof t3 != "object" || t3 === null)
    return false;
  if (Array.isArray(e2))
    return !Array.isArray(t3) || e2.length !== t3.length ? false : e2.some((a3, l3) => t3[l3] === a3);
...
mux-embed/dist/mux.mjs:
  ...
  *)
*/
//# sourceMappingURL=dist-2ULAFWZR.js.map
