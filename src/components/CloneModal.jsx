        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div>
                <Label htmlFor="clientName" className="text-gray-300 mb-2 block">Nombre del Cliente</Label>
                <Input
                  id="clientName"
                  name="clientName"
                  value={clientName}
              ...
              <div>
                <Label htmlFor="projectName" className="text-gray-300 mb-2 block">Nombre del Proyecto/Máquina</Label>
                <Input
                  id="projectName"
                  name="projectName"
                  value={projectName}
            ...
            <div className="flex justify-end gap-3 p-6 border-t border-gray-800 bg-[#0f0f0f]">
              <Button variant="outline" onClick={onClose} disabled={isCloning}>Cancelar</Button>
              <Button onClick={handleClone} disabled={isCloning || !sourceThemeData} className="bg-primary text-black hover:bg-primary/90">
