...
const SpecCard = ({ icon: Icon, title, value, onSave, isEditorMode }) => (
  <motion.div
    variants={{ hidden: { y: 20, opacity: 0 }, visible: { y: 0, opacity: 1 } }}
    className="bg-gray-900/50 p-6 rounded-xl border border-gray-800/80"
  >
        ...
        >
          ...
          >
            {content.specs.map((spec, index) => (
              <SpecCard
                key={spec.id}
                icon={iconMapping[spec.title] || iconMapping['default']}
                title={spec.title}
                value={spec.value}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-400">
            <div className="bg-gray-900/30 p-6 rounded-lg">
                <h4 className="font-semibold text-white mb-2"><EditableText value={content.materiaPrima.title} onSave={(v) => handleSave('materiaPrima', {...content.materiaPrima, title: v})} isEditorMode={isEditorMode} tag="span" /></h4>
            ...
            <div className="bg-gray-900/30 p-6 rounded-lg">
                <h4 className="font-semibold text-white mb-2"><EditableText value={content.specProducto.title} onSave={(v) => handleSave('specProducto', {...content.specProducto, title: v})} isEditorMode={isEditorMode} tag="span" /></h4>
